...
public Plugin myinfo = {
    ...
    description = "An ent_fire script that triggers based on a series of map checks. This is a script for Zombies (@ Phoneburnia) to change difficulty based on players, this plugin automatically enables if people vote for easy difficulty.",
